      ...
      <div class="card-grid">
        ...
        >
          ...
          <div class="card-footer">
            <div class="time-row">
              <span class="time-icon start-icon">
                <svg
                  viewBox="0 0 24 24"
                  fill="currentColor"
                  width="14"
              ...
              >
                {{ formatTime(card.load_start_datetime) }}
              </span>
            </div>
            <div class="time-row">
              <span class="time-icon end-icon">
                <svg
                  viewBox="0 0 24 24"
                  fill="currentColor"
                  width="14"
              ...
              >
                {{ formatTime(card.load_end_datetime) }}
              </span>
            </div>
          </div>
        </div>
