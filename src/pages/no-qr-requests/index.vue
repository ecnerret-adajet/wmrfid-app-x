...
<template>
            ...
            <v-card class="pa-4 bg-grey-50" elevation="2" style="border-radius: 4px;">
                <div class="d-flex align-center">
                    <div class="d-flex align-center justify-center mr-4" style="
                            ...
                            border-radius: 12px;
                        ">
                        <v-icon icon="ri-qr-scan-2-line" color="error" size="24"></v-icon>
                    </div>
                    <div>
                        <span class="text-subtitle-1 font-weight-bold text-grey-700">
                            Total No-QR Requests
                        </span>
    ...
    <FilteringModal @close="filterModalVisible = false" :show="filterModalVisible" :dialogTitle="'Filter No-QR Requests'">
        <template #default>
            <v-form>
                <div class="mt-4">
